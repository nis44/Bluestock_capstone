...
- Duplicate rows: 0
- Column dtypes:
  - `amfi_code`: int64, nulls=0
  - `fund_house`: object, nulls=0
  - `scheme_name`: object, nulls=0
  - `category`: object, nulls=0
  - `sub_category`: object, nulls=0
  - `plan`: object, nulls=0
  - `launch_date`: object, nulls=0
  - `benchmark`: object, nulls=0
  - `expense_ratio_pct`: float64, nulls=0
  - `exit_load_pct`: float64, nulls=0
  - `min_sip_amount`: int64, nulls=0
  - `min_lumpsum_amount`: int64, nulls=0
  - `fund_manager`: object, nulls=0
  - `risk_category`: object, nulls=0
  - `sebi_category_code`: object, nulls=0
...
- Column dtypes:
  - `date`: object, nulls=0
  - `fund_house`: object, nulls=0
  - `aum_lakh_crore`: float64, nulls=0
  - `aum_crore`: int64, nulls=0
  - `num_schemes`: int64, nulls=0
...
- Duplicate rows: 0
- Column dtypes:
  - `month`: object, nulls=0
  - `sip_inflow_crore`: int64, nulls=0
  - `active_sip_accounts_crore`: float64, nulls=0
  - `new_sip_accounts_lakh`: float64, nulls=0
  - `sip_aum_lakh_crore`: float64, nulls=0
  - `yoy_growth_pct`: float64, nulls=12
...
- Column dtypes:
  - `month`: object, nulls=0
  - `category`: object, nulls=0
  - `net_inflow_crore`: float64, nulls=0
...
- Column dtypes:
  - `month`: object, nulls=0
  - `total_folios_crore`: float64, nulls=0
  - `equity_folios_crore`: float64, nulls=0
  - `debt_folios_crore`: float64, nulls=0
  - `hybrid_folios_crore`: float64, nulls=0
  - `others_folios_crore`: float64, nulls=0
...
- Column dtypes:
  ...
  - `return_3yr_pct`: float64, nulls=0
  - `return_5yr_pct`: float64, nulls=0
  - `benchmark_3yr_pct`: float64, nulls=0
  - `alpha`: float64, nulls=0
  - `beta`: float64, nulls=0
  - `sharpe_ratio`: float64, nulls=0
  - `sortino_ratio`: float64, nulls=0
  - `std_dev_ann_pct`: float64, nulls=0
  - `max_drawdown_pct`: float64, nulls=0
  - `aum_crore`: int64, nulls=0
  - `expense_ratio_pct`: float64, nulls=0
  - `morningstar_rating`: int64, nulls=0
  - `risk_grade`: object, nulls=0
...
- Duplicate rows: 0
- Column dtypes:
  - `investor_id`: object, nulls=0
  - `transaction_date`: object, nulls=0
  - `amfi_code`: int64, nulls=0
  - `transaction_type`: object, nulls=0
  - `amount_inr`: int64, nulls=0
  - `state`: object, nulls=0
  - `city`: object, nulls=0
  - `city_tier`: object, nulls=0
  - `age_group`: object, nulls=0
  - `gender`: object, nulls=0
  - `annual_income_lakh`: float64, nulls=0
  - `payment_mode`: object, nulls=0
  - `kyc_status`: object, nulls=0
...
- Column dtypes:
  - `amfi_code`: int64, nulls=0
  - `stock_symbol`: object, nulls=0
  - `stock_name`: object, nulls=0
  - `sector`: object, nulls=0
  - `weight_pct`: float64, nulls=0
  - `market_value_cr`: float64, nulls=0
  - `current_price_inr`: float64, nulls=0
  - `portfolio_date`: object, nulls=0
...
- Column dtypes:
  - `date`: object, nulls=0
  - `index_name`: object, nulls=0
  - `close_value`: float64, nulls=0
